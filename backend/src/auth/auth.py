...
AUTH0_DOMAIN = 'coffee3.us.auth0.com'
ALGORITHMS = ['RS256']
API_AUDIENCE = 'drink'
...
def get_token_auth_header():
    if "Authorization" in request.headers:
        ...
        if auth_header:
            recipebearer_tokens = auth_header.split(' ')
            if recipebearer_tokens[0].lower() == "bearer" and recipebearer_tokens[1]:
                return recipebearer_tokens[1]
    raise AuthError({
        'success': False,
        'message': 'JWT missing',
        'error': 401
